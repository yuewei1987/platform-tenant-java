...
(function () {
    ...
    window.UEDITOR_CONFIG = {
        ...
        , toolbars: [[
            ...
            'simpleupload','insertimage','insertvideo', 'scrawl', 'insertcode', 'background', '|',
            // 'insertimage','insertvideo', 'scrawl', 'insertcode', 'background', '|',
		...
		,whitList: {
			...
			u:      [],
			ul:     ['class', 'style'],
			video:  ['autoplay', 'controls', 'loop', 'height', 'width', 'class', 'style'],
